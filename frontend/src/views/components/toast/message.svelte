...
<div class="w-full mb-4 p-2 rounded shadow-lg text-white {notification.type}">
  <div class="close cursor-pointer flex justify-end w-full">
    <svg
  ...
  <p class="pb-4">{notification.message}</p>
</div>
