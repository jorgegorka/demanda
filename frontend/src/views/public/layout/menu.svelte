...
<nav
  ...
  class:moving-menu={moving}>
  <div
    class="w-full container mx-auto flex flex-wrap items-center justify-between
    mt-0 py-2">
    <div class="pl-4 flex items-center">
      <a
        class="toggleColour no-underline hover:no-underline font-bold text-2xl
        lg:text-4xl text-white"
        href="/">
        <svg
          class="h-8 w-8 -mt-2 fill-current inline"
          ...
          <path
            ...
            C510,82.875,448.8,21.675,369.75,21.675z
            M257.55,419.475H255l-2.55-2.55C130.05,307.274,51,235.875,51,161.925
    ...
    <div class="block lg:hidden pr-4">
      <button
        ...
        border-gray-600 hover:text-gray-800 hover:border-teal-500
    ...
    <div
      ...
      <ul class="list-reset lg:flex justify-end flex-1 items-center">
        ...
        <!-- <li class="mr-3">
          <a
            class="inline-block text-black no-underline hover:text-gray-800
      ...
      <a
        ...
        rounded-full mt-4 lg:mt-0 py-2 px-8 shadow opacity-75">
        Sign up
      </a>
    </div>
  </div>
